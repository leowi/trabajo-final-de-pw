...
<nav class="navbar navbar-expand-lg navbar-light bg-white">
  ...
  <ul class="navbar-nav">
      <li class="nav-item">
        <a href="/patients/add"><button class="button button1">Agregar Paciente</button></a>
      </li>      
    </ul>
    <ul class="navbar-nav ml-auto">
    <li class="nav-item">
      ...
      <li class="nav-item">
        <a href="/patients"><button class="button button2">Pacientes</button></a>
      </li>
       <li class="nav-item">
...
<div class="row">
    <div class="col-sm-12 bg-dark">
      <center class="cent1" >Lista de Pacientes</center>
    </div>
  </div><br>
<div class="container">
  ...
  <br>
   ...
   <tr>				
					...
					<td><%=p.getName() %></td>					
					<td>
					<a href="/patients/delete?id=<%= p.getId() %>" class="btn btn-outline-danger btn-sm RbtnMargin float-right">Delete</button></a>
			    	<a href="/patients/view?id=<%= p.getId() %>" class="btn btn-outline-secondary btn-sm RbtnMargin float-right">View</button></a>
			    	<a href="/patients/update?id=<%= p.getId() %>" class="btn btn-outline-info btn-sm RbtnMargin float-right">Edit</button></a>			    	
			    	<a href="/history/add" class="btn btn-outline-info btn-sm RbtnMargin float-right">Historia</button></a> 	
			    	</td>
			    	<% }%>
