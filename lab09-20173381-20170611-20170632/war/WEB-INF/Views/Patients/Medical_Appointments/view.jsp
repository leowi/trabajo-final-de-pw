	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-12 bg-dark">
				<center class="cent1">Ver Cita Medica</center>
			</div>
		</div>
		<br>
		<div class="container">
				...
				<table class="table">
					<tbody>
						...
						<%} 
							...
							</label> <input value="<%=m_a.getAppointment_date() %>" 
								class="form-control" readonly></td>
							
							<td><label>Estado de la cita: </label> 
									<%
										if (m_a.isStatus() == true) {
									%>
									<input value="Activa" class="form-control" readonly></td>
																
									<%
										} else {
									%>
									<input value="Inactiva" class="form-control" readonly></td>
									<%
										}
									%>
