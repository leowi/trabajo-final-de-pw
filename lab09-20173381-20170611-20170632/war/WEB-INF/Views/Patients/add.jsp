	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-12 bg-dark">
				<center class="cent1">Agregar Paciente</center>
			</div>
		</div>
		<br>
		<div class="container">
					...
					<tbody>
						...
						<tr>
							<td><label>Nombres y apellidos completos: </label> <input
								type="text" name="name" class="form-control" autofocus required
								placeholder="Nombre"></td>
							<td><label>Numero de historia clinica:</label> <input
								type="text" name="ch_number" class="form-control" required
								placeholder="0000/2018" pattern="[0-9]{4}[/]{1}[0-9]{4}">
							</td>
							<td><label>DNI: </label> <input type="text" name="DNI"
								class="form-control" required placeholder="90909090"></td>
						...
						<tr>
							...
							</label> <input type="date" name="created" class="form-control" required></td>
							<td><label>Fecha de nacimiento: </label> <input type="date"
								name="birth" class="form-control" required></td>
							<td><label>Lugar de nacimiento: </label> <input type="text"
								name="place_birth" class="form-control" required
								placeholder="lugar de nacimiento"></td>
						...
						<tr>
							<td><label>Grado de instruccion: </label> <input type="text"
								name="degree_instruction" class="form-control" required
								placeholder="grado de instruccion"></td>
							<td><label>Raza: </label> <input type="text" name="race"
								class="form-control" required placeholder="raza"></td>
							<td><label>Ocupacion: </label> <input type="text"
								name="occupation" class="form-control" required
