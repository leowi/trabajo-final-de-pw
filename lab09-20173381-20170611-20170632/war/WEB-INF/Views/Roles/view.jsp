...
<div class="row">
    <div class="col-sm-12 bg-dark">
      <center class="cent1" >Ver Rol</center>
    </div>
  </div><br>
<!--Fin Obcciones de la parte derecha-->
	<div class="container">
      ...
      <table class="table">
        <tbody>
			<tr>
				<td><label>Nombre</label><input type="text" name="name" class="form-control" value="<%= role.getName() %>" readonly></td>
				<td><label>ID</label><input type="text" class="form-control" value="<%= role.getId() %>" readonly>														
				<td><label>Estado</label><input type="text" class="form-control" value="<%= role.isStatus() %>" readonly>
				<td><label>Fecha de Creación</label><input type="text" name="birthdate" class="form-control" value="<%= created.format(role.getCreated()) %>" readonly></td>
			</tr>
			</tbody>
        </table>
        <br>        
        <div class="trans text-center">
        <a href="/roles" class="btn btn-info btn-responsive">Atras</button></a>
        <br><br>
    </div>
