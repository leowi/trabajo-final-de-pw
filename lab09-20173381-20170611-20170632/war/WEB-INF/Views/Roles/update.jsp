...
<div class="row">
    <div class="col-sm-12 bg-dark">
      <center class="cent1" >Editar Roles</center>
    </div>
  </div><br>
	...
	<form action="/roles/update" method="GET">
        ...
        <tbody>		
			...
			<tr>
				...
				<input type="text" name="name" required autofocus value="<%=role.getName() %>" class="form-control"></td>
				...
				<select name="status" class="form-control">
					...
					<input type="text" name="name" required autofocus value="<%= created.format(role.getCreated()) %>" class="form-control"></td>					
			</tr>
			</tbody>
			</table>
        <br>        
