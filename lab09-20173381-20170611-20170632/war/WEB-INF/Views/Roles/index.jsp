...
<nav class="navbar navbar-expand-lg navbar-light bg-white">
  ...
  <ul class="navbar-nav">
      <li class="nav-item">
        <a href="/roles/add"><button class="button button1">Create</button></a>
      </li>      
    </ul>
    <ul class="navbar-nav ml-auto">
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a href="/roles"><button class="button button2">Roles</button></a>
      </li>
      <li class="nav-item">
...
<div class="row">
    <div class="col-sm-12 bg-dark">
      <center class="cent1" >Lista de Roles</center>
    </div>
  </div><br>
	<div class="container"><input class="form-control" id="myInput" type="text" placeholder="Nombre del rol...">
	<br>
		<% if (roles.size() > 0) { %>
    	...
    	<thead>			
			...
			<tr>
				...
				<td><%=d.isStatus() %>
				<td>
				<a href="/roles/delete?id=<%=d.getId()%>" class="btn btn-outline-danger btn-sm RbtnMargin float-right">Delete</button></a>
		    	<a href="/roles/view?id=<%=d.getId()%>" class="btn btn-outline-secondary btn-sm RbtnMargin float-right">View</button></a>
		    	<a href="/roles/update?id=<%=d.getId()%>" class="btn btn-outline-info btn-sm RbtnMargin float-right">Edit</button></a></td>
    		</tr>
				<% } %>
			    </tbody>
  </table>
  ...
  <% } else { %>
      ...
      <p><a href="/roles/add"> crear nuevo</a></p>
    <% } %>
