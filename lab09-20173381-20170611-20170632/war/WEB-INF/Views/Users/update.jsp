      ...
      <center class="cent1" >Editar Usuario</center>
		...
		<br><br>			
        	...
        	<tbody>				
				...
				<input type="text" name="position"  class="form-control"required value="<%=user.getPosition() %>"></td>				
				<td><label>Especialidad</label>
				<input type="text" name="specialty" class="form-control" required value="<%=user.getSpecialty() %>"></td>
