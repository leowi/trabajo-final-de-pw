...
<div class="row">
    <div class="col-sm-12 bg-dark">
      <center class="cent1" >Ver Usuario</center>
    </div>
  </div><br>		
  <div class="container">
  <br><br>   
      <table class="table">
        <tbody>            
			...
			<input type="text" class="form-control" value="<%= user.getName() %>" readonly></td>
			<td><label>Cargo</label>
			<input type="text" class="form-control" value="<%= user.getPosition() %>" readonly></td>
			<td><label>Especialidad</label>
			<input type="text" class="form-control" value="<%= user.getSpecialty() %>" readonly></td>
			<td><label>Genero</label>
			<input type="text" class="form-control" value="<%= user.getGender() %>" readonly></td>
			</tr>
			<tr>
			<td><label>Email</label>
			<input type="text" class="form-control" value="<%= user.getEmail() %>" readonly></td>
			<td><label>Fecha de nacimiento</label>
			<input type="text" class="form-control" value="<%= birth.format(user.getBirth()) %>" readonly></td>
			<td><label>DNI</label>
			<input type="text" class="form-control" value="<%= user.getDNI() %>" readonly></td>
			<td><label>Telefono</label>
			<input type="text" class="form-control" value="<%= user.getPhone() %>" readonly></td>
			</tr>
			<tr>
			<td><label>Direeccion</label>
			<input type="text" class="form-control" value="<%= user.getAddress() %>" readonly></td>
            ...
            <script>
    			document.getElementById("mySelectRol").value = "<%=user.getIdRole()%>";
			</script>
			<td><label>Estado</label>
			<input type="text" class="form-control" value="<%= user.isStatus() %>" readonly></td>
			<td><label>Fecha de creacion</label>
			<input type="text" class="form-control" value="<%= created.format(user.getCreated()) %>" readonly></td>
			</tr>
			</tbody>
			</table>		
			<br>        
