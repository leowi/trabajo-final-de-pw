...
<div class="row">
    <div class="col-sm-12 bg-dark">
      <center class="cent1" >Editar Acceso</center>
    </div>
  </div><br>
  ...
  <br><br>
	...
	<table class="table">
        <tbody>
			...
			<tr>
				<td><label>Rol</label><select name="role" id="mySelectRol" class="form-control">
				...
				<td><label>Url</label><select name="resource" id="mySelectUrl" class="form-control">
				...
				<input type="text" value="<%= created.format(access.getCreated()) %>" class="form-control">
				</td>
				</tr>
				 </tbody>
        </table>
