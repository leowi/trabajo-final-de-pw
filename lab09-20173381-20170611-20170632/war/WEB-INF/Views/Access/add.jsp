...
<div class="row">
    <div class="col-sm-12 bg-dark">
      <center class="cent1" >Agregar Acceso</center>
    </div>
  </div><br>
  ...
  <br><br>
	...
	<table class="table">
        <tbody>			
			...
			<tr>
			<td><label>Rol</label><select name="role" class="form-control">
          ...
          <td><label>Url</label><select name="resource" class="form-control">
            <option selected value="0">Elige una opción</option>
            <% for (int j = 0;j<resources.size();j++) { %>
            <% Resource res = (Resource)resources.get(j); %>
            <option value="<%=res.getId() %>"><%=res.getUrl() %></option>
            <%} %>
            </select>
          </td>
          </tr>
