...
<div class="row">
    <div class="col-sm-12 bg-dark">
      <center class="cent1" >Editar Recurso</center>
    </div>
  </div><br>
  ...
  <br><br>
	<form action="/resources/update" method="GET">
        ...
        <tbody>
			...
			<tr>
				<td><label>Url</label><input type="text" name="url" class="form-control" value="<%= resource.getUrl() %>" pattern="([/]{1}[a-z]{2,10})*"  class="form-control"></td>
				...
				<input type="text" name="url" class="form-control" value="<%= created.format(resource.getCreated()) %>">
				</td>
			</tr>
			</tbody>
			</table>
