...
<div class="row">
    <div class="col-sm-12 bg-dark">
		...
		<input class="form-control" id="myInput" type="text" placeholder="Nombre del usuario..."><br>
			<% if (users.size() > 0) { %>
			    ...
			    <tbody id="myList">					
					...
					<td><%=u.getEmail() %></td>					
					<td>					
			    	<a href="/petitions/accept?id=<%=u.getId()%>" class="btn btn-outline-info btn-sm RbtnMargin float-right">View</button></a>
			    	</td>
			    	</tr>
      ...
      <div class="alert alert-info alert-dismissible fade show">
					   ...
					   <strong>No hay usuarios registrados recientemente</strong>
					 </div>            
    <% } %>
<script>
